...
window.jscolor || (window.jscolor = function() {
    var e = {
        ...
        tryInstallOnElements: function(t, n) {
            for (var r = new RegExp("(^|\\s)(" + n + ")(\\s*(\\{[^}]*\\})|\\s|$)", "i"), o = 0; o < t.length; o += 1)
                if (void 0 === t[o].type || "color" != t[o].type.toLowerCase() || !e.isColorAttrSupported) {
                    var i;
                    if (!t[o].jscolor && t[o].className && (i = t[o].className.match(r))) {
                        var s = t[o],
                            l = null,
                            a = e.getDataAttr(s, "jscolor");
                        null !== a ? l = a : i[4] && (l = i[4]);
                        var d = {};
                        if (l) try {
                        ...
                        s.jscolor = new e.jscolor(s, d)
                    }
                }
        },
        isColorAttrSupported: function() {
            var e = document.createElement("input");
            return e.setAttribute && (e.setAttribute("type", "color"), "color" == e.type.toLowerCase()) ? !0 : !1
        }(),
        ...
        attachGroupEvent: function(t, n, r, o) {
            e._attachedGroupEvents.hasOwnProperty(t) || (e._attachedGroupEvents[t] = []), e._attachedGroupEvents[t].push([n, r, o]), e.attachEvent(n, r, o)
        },
        ...
        setClass: function(t, n) {
            for (var r = e.classNameToList(n), o = 0; o < r.length; o += 1) e.hasClass(t, r[o]) || (t.className += (t.className ? " " : "") + r[o])
        },
        unsetClass: function(t, n) {
            for (var r = e.classNameToList(n), o = 0; o < r.length; o += 1) {
                var i = new RegExp("^\\s*" + r[o] + "\\s*|\\s*" + r[o] + "\\s*$|\\s+" + r[o] + "(\\s+)", "g");
                t.className = t.className.replace(i, "$1")
            }
        },
        getStyle: function(e) {
        ...
        setStyle: function() {
            ...
            return function(e, t, r) {
                switch (t.toLowerCase()) {
                    case "opacity":
                        var o = Math.round(100 * parseFloat(r));
                        e.style.opacity = r, e.style.filter = "alpha(opacity=" + o + ")";
                        break;
                    default:
                        e.style[n[t]] = r
                }
        ...
        getAbsPointerPos: function(e) {
            ...
            var t = 0,
                n = 0;
            return "undefined" != typeof e.changedTouches && e.changedTouches.length ? (t = e.changedTouches[0].clientX, n = e.changedTouches[0].clientY) : "number" == typeof e.clientX && (t = e.clientX, n = e.clientY), {
                x: t,
                y: n
            }
        },
        getRelPointerPos: function(e) {
            ...
            var t = e.target || e.srcElement,
                ...
                i = 0,
                s = 0;
            return "undefined" != typeof e.changedTouches && e.changedTouches.length ? (i = e.changedTouches[0].clientX, s = e.changedTouches[0].clientY) : "number" == typeof e.clientX && (i = e.clientX, s = e.clientY), r = i - n.left, o = s - n.top, {
                x: r,
                y: o
            }
        },
        ...
        redrawPosition: function() {
            if (e.picker && e.picker.owner) {
                ...
                r.fixed ? (t = e.getElementPos(r.targetElement, !0), n = [0, 0]) : (t = e.getElementPos(r.targetElement), n = e.getViewPos());
                var o, i, s, l = e.getElementSize(r.targetElement),
                    a = e.getViewSize(),
                    d = e.getPickerOuterDims(r);
                ...
                var c = (l[i] + d[i]) / 2;
                if (r.smartPosition) var h = [-n[o] + t[o] + d[o] > a[o] && -n[o] + t[o] + l[o] / 2 > a[o] / 2 && t[o] + l[o] - d[o] >= 0 ? t[o] + l[o] - d[o] : t[o], -n[i] + t[i] + l[i] + d[i] - c + c * s > a[i] ? -n[i] + t[i] + l[i] / 2 > a[i] / 2 && t[i] + l[i] - c - c * s >= 0 ? t[i] + l[i] - c - c * s : t[i] + l[i] - c + c * s : t[i] + l[i] - c + c * s >= 0 ? t[i] + l[i] - c + c * s : t[i] + l[i] - c - c * s];
                else var h = [t[o], t[i] + l[i] - c + c * s];
                var p = h[o],
                    u = h[i],
                    m = r.fixed ? "fixed" : "absolute",
                    v = (h[0] + d[0] > t[0] || h[0] < t[0] + l[0]) && h[1] + d[1] < t[1] + l[1];
                e._drawPosition(r, p, u, m, v)
            }
        },
        _drawPosition: function(t, n, r, o, i) {
            var s = i ? 0 : t.shadowBlur;
            e.picker.wrap.style.position = o, e.picker.wrap.style.left = n + "px", e.picker.wrap.style.top = r + "px", e.setBoxShadow(e.picker.boxS, t.shadow ? new e.BoxShadow(0, s, t.shadowBlur, 0, t.shadowColor) : null)
        },
        ...
        onControlPointerStart: function(t, n, r, o) {
            var i = n._jscInstance;
            e.preventDefault(t), e.captureTarget(n);
            var s = function(i, s) {
                e.attachGroupEvent("drag", i, e._pointerMoveEvent[o], e.onDocumentPointerMove(t, n, r, o, s)), e.attachGroupEvent("drag", i, e._pointerEndEvent[o], e.onDocumentPointerEnd(t, n, r, o))
            };
        ...
        onDocumentPointerMove: function(t, n, r, o, i) {
            return function(t) {
                var o = n._jscInstance;
                switch (r) {
                    case "pad":
                        t || (t = window.event), e.setPad(o, t, i[0], i[1]), e.dispatchFineChange(o);
                        break;
                    case "sld":
                        t || (t = window.event), e.setSld(o, t, i[1]), e.dispatchFineChange(o)
                }
            }
        },
        onDocumentPointerEnd: function(t, n, r, o) {
            return function(t) {
        ...
        dispatchFineChange: function(e) {
            if (e.onFineChange) {
                var t;
                t = "string" == typeof e.onFineChange ? new Function(e.onFineChange) : e.onFineChange, t.call(e)
            }
        },
        setPad: function(t, n, r, o) {
            var i = e.getAbsPointerPos(n),
                s = r + i.x - e._pointerOrigin.x - t.padding - t.insetWidth,
                l = o + i.y - e._pointerOrigin.y - t.padding - t.insetWidth,
                a = s * (360 / (t.width - 1)),
                d = 100 - l * (100 / (t.height - 1));
            switch (e.getPadYComponent(t)) {
                case "s":
                    t.fromHSV(a, d, null, e.leaveSld);
                    break;
                case "v":
                    t.fromHSV(a, null, d, e.leaveSld)
            }
        },
        setSld: function(t, n, r) {
            var o = e.getAbsPointerPos(n),
                i = r + o.y - e._pointerOrigin.y - t.padding - t.insetWidth,
                s = 100 - i * (100 / (t.height - 1));
            switch (e.getSliderComponent(t)) {
                case "s":
                    t.fromHSV(null, s, null, e.leavePad);
                    break;
                case "v":
                    t.fromHSV(null, null, s, e.leavePad)
            }
        },
        _vmlNS: "jsc_vml_",
        ...
        initVML: function() {
            if (!e._vmlReady) {
                var t = document;
                if (t.namespaces[e._vmlNS] || t.namespaces.add(e._vmlNS, "urn:schemas-microsoft-com:vml"), !t.styleSheets[e._vmlCSS]) {
                    ...
                    for (var o = 0; o < n.length; o += 1) r.addRule(e._vmlNS + "\\:" + n[o], "behavior:url(#default#VML);")
                }
                e._vmlReady = !0
            }
        },
            ...
            if (e.isCanvasSupported) {
                var n = document.createElement("canvas"),
                    ...
                    o = function(e, t, o) {
                        ...
                        var i = r.createLinearGradient(0, 0, n.width, 0);
                        i.addColorStop(0, "#F00"), i.addColorStop(1 / 6, "#FF0"), i.addColorStop(2 / 6, "#0F0"), i.addColorStop(.5, "#0FF"), i.addColorStop(4 / 6, "#00F"), i.addColorStop(5 / 6, "#F0F"), i.addColorStop(1, "#F00"), r.fillStyle = i, r.fillRect(0, 0, n.width, n.height);
                ...
                var s = document.createElement(e._vmlNS + ":fill");
                s.type = "gradient", s.method = "linear", s.angle = "90", s.colors = "16.67% #F0F, 33.33% #00F, 50% #0FF, 66.67% #0F0, 83.33% #FF0";
                var l = document.createElement(e._vmlNS + ":rect");
                l.style.position = "absolute", l.style.left = "-1px", l.style.top = "-1px", l.stroked = !1, l.appendChild(s), i.appendChild(l);
                var a = document.createElement(e._vmlNS + ":fill");
                a.type = "gradient", a.method = "linear", a.angle = "180", a.opacity = "0";
                var d = document.createElement(e._vmlNS + ":rect");
                d.style.position = "absolute", d.style.left = "-1px", d.style.top = "-1px", d.stroked = !1, d.appendChild(a), i.appendChild(d);
                var o = function(e, t, n) {
                    switch (i.style.width = e + "px", i.style.height = t + "px", l.style.width = d.style.width = e + 1 + "px", l.style.height = d.style.height = t + 1 + "px", s.color = "#F00", s.color2 = "#F00", n.toLowerCase()) {
                        case "s":
        ...
        createSliderGradient: function() {
            ...
            if (e.isCanvasSupported) {
                ...
                var o = function(e, t, n, r) {
                    i.style.width = e + "px", i.style.height = t + "px", l.style.width = e + 1 + "px", l.style.height = t + 1 + "px", s.color = n, s.color2 = r
                };
                t.elm = i, t.draw = o
            }
            return t
        ...
        jscolor: function(t, n) {
            function r(e, t, n) {
                ...
                return [60 * (6 === s ? 0 : s), 100 * (i / o), 100 * o]
            }
            ...
            function i() {
                e.unsetClass(m.targetElement, m.activeClass), e.picker.wrap.parentNode.removeChild(e.picker.wrap), delete e.picker.owner
            }

            function s() {
                function t() {
                    var e = m.insetColor.split(/\s+/),
                        t = e.length < 2 ? e[0] : e[1] + " " + e[0] + " " + e[0] + " " + e[1];
                    n.btn.style.borderColor = t
                }
                m._processParentElementsInDOM(), e.picker || (e.picker = {
                    owner: null,
                ...
                var n = e.picker,
                    r = !!e.getSliderComponent(m),
                    o = e.getPickerDims(m),
                    i = 2 * m.pointerBorderWidth + m.pointerThickness + 2 * m.crossSize,
                    s = e.getPadToSliderPadding(m),
                    d = Math.min(m.borderRadius, Math.round(m.padding * Math.PI)),
                    c = "crosshair";
                ...
                n.btn.onmousedown = function() {
                    m.hide()
                }, n.btnT.style.lineHeight = m.buttonHeight + "px", n.btnT.innerHTML = "", n.btnT.appendChild(document.createTextNode(m.closeText)), l(), a(), e.picker.owner && e.picker.owner !== m && e.unsetClass(e.picker.owner.targetElement, m.activeClass), e.picker.owner = m, e.isElementType(v, "body") ? e.redrawPosition() : e._drawPosition(m, 0, 0, "relative", !1), n.wrap.parentNode != v && v.appendChild(n.wrap), e.setClass(m.targetElement, m.activeClass)
            }

            function l() {
                switch (e.getPadYComponent(m)) {
                    case "s":
                        var t = 1;
                        break;
                    case "v":
                ...
                var n = Math.round(m.hsv[0] / 360 * (m.width - 1)),
                    r = Math.round((1 - m.hsv[t] / 100) * (m.height - 1)),
                    i = 2 * m.pointerBorderWidth + m.pointerThickness + 2 * m.crossSize,
                    s = -Math.floor(i / 2);
                switch (e.picker.cross.style.left = n + s + "px", e.picker.cross.style.top = r + s + "px", e.getSliderComponent(m)) {
                    case "s":
                        var l = o(m.hsv[0], 100, m.hsv[2]),
                            a = o(m.hsv[0], 0, m.hsv[2]),
                            d = "rgb(" + Math.round(l[0]) + "," + Math.round(l[1]) + "," + Math.round(l[2]) + ")",
                            c = "rgb(" + Math.round(a[0]) + "," + Math.round(a[1]) + "," + Math.round(a[2]) + ")";
                        e.picker.sldGrad.draw(m.sliderSize, m.height, d, c);
                        break;
                    case "v":
                        var h = o(m.hsv[0], m.hsv[1], 100),
                            d = "rgb(" + Math.round(h[0]) + "," + Math.round(h[1]) + "," + Math.round(h[2]) + ")",
                            c = "#000";
                        e.picker.sldGrad.draw(m.sliderSize, m.height, d, c)
                }
            }
            ...
            function a() {
                ...
                if (t) {
                    ...
                    var r = Math.round((1 - m.hsv[n] / 100) * (m.height - 1));
                    e.picker.sldPtrOB.style.top = r - (2 * m.pointerBorderWidth + m.pointerThickness) - Math.floor(g / 2) + "px"
                }
            }

            function d() {
                return e.picker && e.picker.owner === m
            }
            ...
            for (var h in n) n.hasOwnProperty(h) && (this[h] = n[h]);
            if (this.hide = function() {
                ...
                t & e.leaveStyle || this.styleElement && (this.styleElement.style.backgroundImage = "none", this.styleElement.style.backgroundColor = "#" + this.toString(), this.styleElement.style.color = this.isLight() ? "#000" : "#FFF"), !(t & e.leavePad) && d() && l(), !(t & e.leaveSld) && d() && a()
                ...
                this.rgb = o(null === e ? this.hsv[0] : this.hsv[0] = e, null === t ? this.hsv[1] : this.hsv[1] = t, null === n ? this.hsv[2] : this.hsv[2] = n), this.exportColor(r)
                ...
                var s = r(null === e ? this.rgb[0] : e, null === t ? this.rgb[1] : t, null === n ? this.rgb[2] : n);
                ...
                var l = o(this.hsv[0], this.hsv[1], this.hsv[2]);
                this.rgb[0] = l[0], this.rgb[1] = l[1], this.rgb[2] = l[2], this.exportColor(i)
                ...
                if (!this._linkedElementsProcessed) {
                    ...
                    do {
                        var n = e.getStyle(t);
                        n && "fixed" === n.position.toLowerCase() && (this.fixed = !0), t !== this.targetElement && (t._jscEventsAttached || (e.attachEvent(t, "scroll", e.onParentScroll), t._jscEventsAttached = !0))
                    } while ((t = t.parentNode) && !e.isElementType(t, "body"))
                }
            }, "string" == typeof t) {
                var p = t,
                    u = document.getElementById(p);
                u ? this.targetElement = u : e.warn("Could not find target element with ID '" + p + "'")
            } else t ? this.targetElement = t : e.warn("Invalid target element: '" + t + "'");
            if (this.targetElement._jscLinkedInstance) return void e.warn("Cannot link jscolor twice to the same element. Skipping.");
            ...
            if (e.isElementType(this.targetElement, "button"))
                if (this.targetElement.onclick) {
                    var y = this.targetElement.onclick;
            ...
            if (this.valueElement && e.isElementType(this.valueElement, "input")) {
                var f = function() {
                    m.fromString(m.valueElement.value, e.leaveValue), e.dispatchFineChange(m)
                };
                e.attachEvent(this.valueElement, "keyup", f), e.attachEvent(this.valueElement, "input", f), e.attachEvent(this.valueElement, "blur", c), this.valueElement.setAttribute("autocomplete", "off")
            }
