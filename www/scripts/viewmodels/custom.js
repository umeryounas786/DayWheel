...
$( document ).ready(function() {
    ...
    $("#logout").click(function(){
        ...
        service.operationDataService('logout',data,function(data){
            console.log(data);
            if(data.data[0].Status == "true"){
                ...
                localStorage.removeItem("filterDisplayContent");
    ...
    //Search Bar
        $( ".header-elements a > i.fa-search" ).click(function() {
            $(".header-elements .search-section").slideToggle();
            $('#My-search').focus();
        });
    ...
    $("#contactSubmitButton").on("click",function(){
        ...
        var validationStatus = validateForm(name,email,contactNumber,message);

        if(validationStatus == "success"){

            var data = {"User_id":localStorage.getItem('User_id'),"token":localStorage.getItem('token'),"name":name,"email":email,"phone_no":contactNumber,"message":message}
            data = JSON.stringify(data);
            console.log(data);
    ...
    function validateForm(name,email,contactNumber,message){
            ...
            if(email != ''){
                ...
                if(emailValidationStatus == true){
                    ...
                    if(contactNumber != ''){
                        ...
                        var contactValidationStatus = validateContactNum(contactNumber);

                        if(contactValidationStatus == true){
                ...
                toastr.options.positionClass = "toast-bottom-right";
                toastr.options.timeout = 500;
                toastr.warning('Enter your email id');
